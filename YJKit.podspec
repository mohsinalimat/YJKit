...
Pod::Spec.new do |s|
  ...
  s.homepage         = "https://github.com/Jack Huang/YJKit"
  s.license          = 'MIT'
  s.author           = { "Jack Huang" => "jack-huang-developer@foxmail.com" }
  s.source           = { :git => "https://github.com/Jack Huang/YJKit.git", :tag => s.version.to_s }
