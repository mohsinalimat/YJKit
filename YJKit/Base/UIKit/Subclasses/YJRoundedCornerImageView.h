 ...
 *  - Tap the Xcode Identity Inspector, select the UIImageView and Change it's class to YJRoundedCornerImageView.
 ...
 *
 *  Here is a tip to reveal the invisible YJRoundedCornerImageView without image content:
 *  - In the Interface Builder(.xib or .storyboard), go to Xcode menu bar -> Editor -> Canvas -> Show Bounds Rectangles.
 *
 */

IB_DESIGNABLE
@interface YJRoundedCornerImageView : YJMaskedImageView

/// The radius to use when showing rounded corners for the image content. Default is 10.0f
